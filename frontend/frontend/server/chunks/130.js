...
const ButtonDefault = ({ size , title , color , bgcolor , children , className , href , disabled , ...props })=>{
    const isColor = color !== null && color !== void 0 ? color : '';
    const isBgColor = bgcolor !== null && bgcolor !== void 0 ? bgcolor : '';
    const isHref = href !== null && href !== void 0 ? href : '';
    switch(size){
        case 'full':
...
var _REACT_APP_BACKEND_URL;
const BASE_URL = (_REACT_APP_BACKEND_URL = process.env.REACT_APP_BACKEND_URL) !== null && _REACT_APP_BACKEND_URL !== void 0 ? _REACT_APP_BACKEND_URL : 'http://localhost:8080/api';
